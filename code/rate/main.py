...
if args.mode.lower() == 'train':
    with tf.Session() as sess:
        ...
        for tr in range(args.n_trials):
            ...
            if args.task.lower() == 'go-nogo':
                ...
                if (tr-1)%training_params['eval_freq'] == 0:
                    ...
                    if eval_loss_mean < training_params['loss_threshold'] and eval_perf_mean > 0.95 and tr > 500:
        ...
        if len(settings['taus']) > 1:
            fname = 'Prob_{}_Task_{}_N_{}_Taus_{}_{}_Act_{}_{}.mat'.format(settings['prob'], args.task.lower(), N, settings['taus'][0], 
                    settings['taus'][1], training_params['activation'], fname_time)
        elif len(settings['taus']) == 1:
            fname = 'Prob_{}_Task_{}_N_{}_Tau_{}_Act_{}_{}.mat'.format(settings['prob'], args.task.lower(), N, settings['taus'][0], 
